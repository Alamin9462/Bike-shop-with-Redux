...
const HomeSlider = () => {
  return (
    <div className="w-full max-w-6xl mx-auto mt-6">
      <div className="carousel w-full rounded-xl shadow-2xl overflow-hidden relative">
        {/* Slide 1 */}
        <div id="item1" className="carousel-item w-full relative group">
          <img
            className="w-full h-[450px] object-cover group-hover:scale-105 transition-transform duration-700"
            src="https://i.ibb.co.com/Zn9szV5/bike-Banner-1.png"
            alt="bike-Banner-1"
          />
          {/* Gradient + Shape */}
        ...
        <div id="item3" className="carousel-item w-full relative group">
          <img
            className="w-full h-[450px] object-cover group-hover:scale-105 transition-transform duration-700"
            src="https://i.ibb.co.com/tpNrCGWD/pexels-cottonbro-5803142.jpg"
